      ...
      <div className="relative min-h-screen flex flex-col items-center px-4">
        <div className="w-full min-h-screen flex flex-col" style={{ maxWidth: MAX_CONTENT_WIDTH }}>
          ...
          >
            ...
            <div className="bg-[#14141c]/95 backdrop-blur-md border border-white/[0.06] rounded-2xl mx-1 px-3 py-2.5">
              <div className="flex items-center justify-between">
                {/* Left: Back arrow */}
                <Link 
                  href="/" 
                  className="w-8 h-8 flex items-center justify-center hover:bg-white/[0.06] rounded-xl transition-colors"
                >
                  <ArrowLeft className="w-4 h-4 text-white/70" />
                </Link>
                
                {/* Center: Polymarket logo + text */}
                <div className="flex items-center gap-2">
                  <Image 
                    ...
                    unoptimized
                  />
                  <span className="text-white font-semibold text-sm">Polymarket</span>
                </div>
                
                {/* Right: Refresh + Portfolio + Deposit */}
                <div className="flex items-center gap-1.5">
                  ...
                  {/* Portfolio button with total value */}
                  <button
                    onClick={() => setShowPositions(true)}
                    className="flex items-center gap-1 px-2 py-1 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] rounded-lg transition-colors"
                  >
                    <Wallet className="w-3 h-3 text-white/60" />
                    <span className="text-white text-[11px] font-medium">${parseFloat(usdcBalance).toFixed(2)}</span>
                  </button>
                  
                  {/* Deposit button - Polymarket blue, smaller */}
                  <button
                    onClick={() => setShowBridgeModal(true)}
                    className="px-2.5 py-1 text-white font-medium rounded-lg text-[11px] transition-all hover:brightness-110 active:scale-[0.98]"
            ...
            {/* Search bar - inside header card area */}
            <div className="px-1 pb-2 pt-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-[#14141c] border border-white/[0.06] rounded-xl text-white placeholder:text-white/30 outline-none focus:border-white/[0.12] focus:bg-white/[0.08] transition-all text-sm"
                />
              </div>
            </div>
          </header>
