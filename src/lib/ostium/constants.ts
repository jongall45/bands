...
export const OSTIUM_PAIRS = [
  { id: 0, symbol: 'BTC-USD', name: 'Bitcoin', category: 'crypto', maxLeverage: 200, from: 'BTC', to: 'USD' },
  { id: 1, symbol: 'ETH-USD', name: 'Ethereum', category: 'crypto', maxLeverage: 200, from: 'ETH', to: 'USD' },
  { id: 2, symbol: 'SOL-USD', name: 'Solana', category: 'crypto', maxLeverage: 100, from: 'SOL', to: 'USD' },
  ...
  { id: 10, symbol: 'EUR-USD', name: 'Euro', category: 'forex', maxLeverage: 200, from: 'EUR', to: 'USD' },
  { id: 11, symbol: 'GBP-USD', name: 'British Pound', category: 'forex', maxLeverage: 200, from: 'GBP', to: 'USD' },
  { id: 12, symbol: 'USD-JPY', name: 'Japanese Yen', category: 'forex', maxLeverage: 200, from: 'USD', to: 'JPY' },
  { id: 13, symbol: 'AUD-USD', name: 'Australian Dollar', category: 'forex', maxLeverage: 200, from: 'AUD', to: 'USD' },
  { id: 14, symbol: 'USD-CAD', name: 'Canadian Dollar', category: 'forex', maxLeverage: 200, from: 'USD', to: 'CAD' },
  { id: 15, symbol: 'USD-CHF', name: 'Swiss Franc', category: 'forex', maxLeverage: 200, from: 'USD', to: 'CHF' },
